<template>
  <view class="main is-white">
    ...
    <AddFolder :visible.sync="fileVisible" :categoryId="type" parentId="0" @refresh="docRefresh" />
  </view>
</template>
    ...
    if (obj.key === 'add') {
      ...
      uni.showActionSheet({
        ...
        success: function (res) {
          if (!res.tapIndex) {
            //新建文件
            that.$utils.toUrl(`/pages/dataManage/projectFile/uploadFile?type=${that.type}&id=0`)
            return
          }
          //新建文件夹
