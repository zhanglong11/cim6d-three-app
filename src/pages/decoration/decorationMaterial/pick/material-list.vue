    ...
    <div class="filter">
      ...
      <div class="line">
        <div class="common-select">
          <span class="common-select-label">材料类型:</span>
          <span class="common-select-value">
            <uni-select v-model="filterForm.type" placeholder="请选择材料类型" :options="materialTypeList">
            </uni-select>
...
export default {
  ...
  data() {
    return {
      materialTypeList: [{ value: null, label: '全部' }, ...materialTypeList],
      filterForm: {
        keyword: '',
        type: null,
        page: 1,
