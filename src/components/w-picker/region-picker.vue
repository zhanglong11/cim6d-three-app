  ...
  methods: {
    getData() {
      ...
      if (typeof value === 'object') {
        ...
        a1 = value.substring(0, 2) + '0000'
        a2 = value.substring(0, 4) + '00'
        a3 = value
        value = [a1, a2, a3]
      }
      ...
      let show = this.value ? true : false
      // console.log(4444, value, province, city, area, show)
    ...
    initData() {
      ...
      obj.result = result
      obj.value = [obj.province.value, obj.city.value, obj.area.value]
      this.checkObj = obj
      this.$nextTick(() => {
    ...
    handlerChange(e) {
      ...
      let areas = this.hideArea
        ? []
        : (citys[cityIndex] && citys[cityIndex].children) || citys[citys.length - 1].children || []
